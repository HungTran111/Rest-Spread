...
console.log(addKeyVal({name: "Hung"}, "age", 25));
...
console.log(removeKey({name: "Hung", age: 25}, "age"));
...
console.log(combine({first: "Hung"}, {last: "Tran"}));
...
console.log(update({name: "Hung", age: 24}, "age", 25));
